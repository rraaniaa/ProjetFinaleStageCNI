    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-sm-9">
          <div class="left-info">
            <ul>
              <li><a href="#"><i class="fa fa-phone"></i> +216 71 783 055</a></li>
              <li><a href="#"><i class="fa fa-envelope"></i>webcni@cni.tn </a></li>
              <li><a href="#"><i class="fa fa-map-marker"></i>17 Rue Belhassen Ben Chaabane 1005 El-Omrane</a></li>
            </ul>
          </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    <!-- ***** Logo Start ***** -->
                    <a href="www.cni.tn" class="logo">
                        <img src="images\avatar-removebg-preview.png" alt="" style="max-width: 150px;">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="images\services-01.jpg" alt="discover SEO" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="images\services-02.jpg" alt="data analysis" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="images\services-03.jpg" alt="precise data" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="images\services-04.jpg" alt="SEO marketing" class="templatemo-feature">
                </div>
        ...
        <div class="col-lg-12">
          <div class="contact-us-content">
            <div class="row">
              ...
              <div class="col-lg-8"   style="  text-align: center; "><h2><em>Contact Us</em> &amp; Get In <span>Touch</span></h2>
              <img src="../images/qrr.png" style="width: 350px;    margin-left: 0px;
